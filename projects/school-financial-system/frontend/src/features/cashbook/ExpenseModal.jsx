      ...
      <div className="w-full max-w-md bg-[#0B192C]/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden transform transition-all">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <span className="text-rose-400 font-bold text-sm">KES</span>
              </div>
              <input
                type="number"
                className="edtech-input pl-12 financial-data text-rose-400 text-lg font-bold"
                placeholder="0.00"
          ...
          <div className="pt-4 flex justify-end gap-3 border-t border-white/10 mt-6">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="edtech-btn px-6 py-2 text-sm disabled:opacity-70 disabled:cursor-not-allowed !bg-rose-500 !text-white !shadow-[0_4px_14px_0_rgba(244,63,94,0.39)] hover:!bg-rose-600 hover:!shadow-[0_6px_20px_rgba(244,63,94,0.5)]"
            >
              {isPending ? (
                <>
